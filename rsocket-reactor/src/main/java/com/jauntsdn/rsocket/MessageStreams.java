...
/** Channel interactions for async exchange of binary messages using Project Reactor API. */
public interface MessageStreams extends Closeable {

  /**
   * Unreliable and unordered 1 to 0 messages exchange interaction.
   *
   * @return {@link Mono} completed successfully as soon as message is scheduled for write if
   ...
   *
   * @return {@link Mono} completed successfully with exactly 1 response message, otherwise
