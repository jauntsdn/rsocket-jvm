...
public interface ServerAcceptor {
   ...
   *     from the peer.
   */
  Single<RSocket> accept(SetupMessage setup, RSocket sendingSocket);

  /**
   * Contract to decorate a {@link ServerAcceptor}, providing access to connection {@code setup}
   ...
   */
  @FunctionalInterface
  interface Interceptor extends Function<ServerAcceptor, ServerAcceptor> {}
}
